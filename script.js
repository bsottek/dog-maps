mapboxgl.accessToken = 'pk.eyJ1Ijoib2tuaS1jIiwiYSI6ImNrbXdpOW91bjBmYzMycHFwczh5eHdrZHMifQ.cXMnTV3VRA4sCJzcH3ittg';
var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    center: [-86.76604789516422, 36.17679406889922],
    zoom: 11.15
});
                    ...
                    'features': [
                        {
                            ...
                            'properties': {
                                'description':
                                    '<strong>Dog Park 1</strong><p>This is a great place to walk your dog bro, trust me.</p>'
                            },
                            'geometry': {
                                'type': 'Point',
                                'coordinates': [-86.76604789516422, 36.17679406889922]
                            }
                        },
                        {
                            'type': 'Feature',
